...
=== start ===
Estás en el trabajo haciendo las tareas correspondientes de tu día a día, de pronto tu compañerx NOM-COMPAÑERx te habla porque al parecer JORGE está pasando por una crisis de pánico. NOM-COMPAÑERX no se siente preparadx para este tipo de situaciones, pero sabe que usaste EmpathySense y que tú si tienes el conocimiento necesario.  #title:Contexto
Oye USER algo le pasa a AFECTADX, fíjate, parece que está llorando.  #title:Compañero
Se nota que está mal, quizá le pasó algo o anda estresado, igual es entendible, ha tocado harta pega estos días.  #title:Compañero
Podrías ir a ver qué le pasa, tú sabes cómo ayudar, estudiaste qué hacer en estos casos, si voy yo no sabría qué decir.  #title:Compañero
->first_choice
...
/* PASO A  */
 ...
 === five_choice === 
 ¿Qué debería responder? #title:Tú
    * Jorge yo percibo que no estás pasándolo muy bien ahora, entonces si te sientes cómodo y quieres comentarte algo o desahogarte yo tengo la disposición de escucharte.
    ~ raise(correctAnswers)
    * ¿Qué te pasó?
    ~ raise(mistakes)
...
- \(Habla un poco más rápido y está levemente agitado) #title:Jorge 
...
-Sí, bueno quizá sea que no he tenido muchas oportunidades para que me conozcan. Después del trabajo no me quedan muchas energías para nada, me voy a la casa apenas salgo. ¡Estoy harto! #title:Jorge
...
/* PASO B  */
 ...
 ¿Qué debería responder? #title:Tú
    * Si me dices las cosas que te preocupan, podemos ordenarlas e ir mejorando la situación.
    ~ raise(mistakes)
    ->ten_choice
    * Mira percibo que estás algo angustiado, yo conozco un ejercicio de respiración que me ha servido harto en este tipo de situaciones para encontrar calma, ¿te gustaría que lo probemos?  
    ~ raise(correctAnswers)
...
=== seventeen_choice ===
 ¿Qué debería responder? #title:Tú
    * Este es un muy buen ejercicio, puedes aplicarlo en esta situación o alguna parecida donde creas perder la calma. También vi que recomiendan practicarlo al despertar o antes de dormir, para mejorar sus resultados.  
    ~ raise(correctAnswers)
...
-Gracias, lo tendré en cuenta. Estos días me haría muy bien al dormir sobretodo. #title:Jorge
...
=== eighteen_choice ===
 ¿Qué debería responder? #title:Tú
    ...
    * Yo creo que podrías hablar con un terapeuta o alguien profesional
    ~ raise(mistakes)
    * Jorge y ahora que te sientes más tranquilo y retomando lo que me contaste, ¿que sientes que es lo más necesitas resolver ahora? 
    ~ raise(correctAnswers)
...
=== twenty_one_choice ===
 ¿Qué debería responder? #title:Tú
    * Entonces, ordenando lo que me comentaste, me decías que tienes mucho trabajo, poco tiempo, y estás muy justo con el dinero que ganas ¿Y de esto, que crees que es lo que más te aliviaría resolver primero? 
    ~ raise(correctAnswers)
...
-Con el convenio quedan súper accesible, igual te puedo recomendar otros que son baratos [INFO]. Y si tienes alguna duda puedes llamar a Salud Responde (600 360 7777) que está disponible las 24 horas y pueden darte recomendaciones. #title:Tú
...
=== twenty_six_choice ===
 ¿Qué debería responder? #title:Tú
    * Si sientes que vuelves a experimentar algo similar o una situación parecida a lo que experimentaste hoy, puedes recordar lo que te ayudó a recuperar la calma e implementarlo si lo necesitas.  
    ~ raise(correctAnswers)
...
=== twenty_seven_choice ===
 ¿Qué debería responder? #title:Tú
    * Exacto, puedes aplicarlo cuando te sientas un poco agitado o estresado, también hay otras estrategias que se ha visto que sirven harto, como mantener horarios de descansos regulares y compartir con amigos o familiares  
    ~ raise(correctAnswers)
